            ...
            <div class="layout-content-body container" style="background-color: #e0e0e0;font-weight: 700; min-height:100vh;">
                ...
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <a href="" data-toggle="modal" data-target="#partnerModal" class="pull-right"> + Add New Partner</a>
            ...
            <div class="modal-content">
                <form action="" method="post">
                    <div class="modal-header text-center">
                        <h4 class="modal-title w-100 font-weight-bold">Add New Lending Partner</h4>
                    ...
                    <div class="modal-body mx-3">
                        ...
                        <div class="form-group">
                            <label for="">Select Partner Image</label>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="" method="post">
                    ...
                    <div class="modal-footer d-flex justify-content-center">
                        <h4 class="pull-left">Are you sure you want to remove this lender?</h4>
    ...
    <script>
        (function($) {
            ...
            function create_preview(that, src, settings) {
                ...
                // The preview image
                var picker_preview_image = $('<img src="' + src + '" class="img-responsive img-rounded" style="margin:auto;" />');
