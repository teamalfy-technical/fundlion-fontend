            ...
            <div class="layout-content-body container" style="background-color: #e0e0e0;font-weight: 700; min-height:100vh;">
                ...
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1">
                        <h2 style="color: #000000;font-weight: 900;">Edit <span style="font-weight: 100;">Homepage</span></h2>
                    </div>
                </div>
                ...
                <div class="row ">
                    <div class="col-lg-6 col-lg-offset-1">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                <label for="formGroupExampleInput">Banner Heading</label>
                                <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Example input">
                            </div>
                            <div class="form-group">
                                <label for="formGroupExampleInput2">Banner Text</label>
